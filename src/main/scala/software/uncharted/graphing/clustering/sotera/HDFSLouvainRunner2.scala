 ...
 */
class HDFSLouvainRunner2(minProgressFactor:Double,progressCounter:Int,outputdir:String) extends LouvainHarness2(minProgressFactor:Double,progressCounter:Int){
